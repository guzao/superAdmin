    ...
    <div class="flex justify-between items-center h-full">
      ...
      <div class="left_info flex items-center h-full relative">
        ...
        <div class="left_base_info">
          <div class="left_base_info_name">综合性能</div>
        </div>
      </div>
      ...
      <div class="right_info flex">
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">5059</div>
          <div class="info_item_label">累计充电量(kWh)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">3998</div>
          <div class="info_item_label">累计放电量(kWh)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">70.1</div>
          <div class="info_item_label">平均可用率(%)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">92.7</div>
          <div class="info_item_label">平均循环效率(%)</div>
        </div>
      </div>
    </div>
  </div>
