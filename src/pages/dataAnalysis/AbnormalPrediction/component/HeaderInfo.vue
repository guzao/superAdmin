    ...
    <div class="flex justify-between items-center h-full">
      ...
      <div class="left_info flex items-center h-full relative">
        ...
        <div class="left_base_info">
          <div class="left_base_info_name">异常预测</div>
        </div>
      </div>
      ...
      <div class="right_info flex">
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">8</div>
          <div class="info_item_label">电池异常预测异常数(个)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">32</div>
          <div class="info_item_label">电池特性预测异常数(个)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">23</div>
          <div class="info_item_label">已发起工单异常数(个)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">26</div>
          <div class="info_item_label">未发起工单异常数(个)</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">25</div>
          <div class="info_item_label">无需发起工单异常数(个)</div>
        </div>
      </div>
    </div>
  </div>
