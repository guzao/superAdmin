      ...
      <div class="right_info flex">
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">
            {{ titleInfo?.minTemp }}/{{ titleInfo?.maxTemp }}
          </div>
          <div class="info_item_label">最低/最高温度({{ titleInfo?.maxTempSignal }})</div>
          <SplitLine />
        </div>
        <div class="info_item text-center relative">
          <div class="info_item_value semi_bold">
...
const props = defineProps({
  titleInfo: {
    type: Object as PropType<DeviceList | null>,
    required: true,
  },
  modelValue: {
    type: Boolean,
...
const emits = defineEmits(["onSelect", "update:modelValue"]);
const updateState = () => emits("update:modelValue", !props.modelValue);
</script>
