...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const verifySuccessFun = () => {
      ...
      document
        .getElementsByTagName("html")[0]
        .removeEventListener("mouseup", moseUpHandler);
      slideWidth.value = maxWidth.value;
    };
...
//滑块滑过区域的样式
.slider-left-bg {
  background-color: rgba(125, 205, 69, 1);
  width: 0;
  height: 100%;
  border-radius: 6px 0 0 6px;
}
